        ...
        try {
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                if (currentDetail.has("webTitle")) {
                    // Extract the value for the book title called "title"
                    authorName = currentDetail.getString("webTitle");
                }
                ...
                if (currentDetail.has("webPublicationDate")) {
                    webPublicationDate = currentDetail.getString("webPublicationDate");
                }


                Word details = new Word(sectionName, authorName, url,webPublicationDate);
